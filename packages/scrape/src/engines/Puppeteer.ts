...
import { BrowserName, DeviceCategory, Dictionary, PuppeteerCrawler, PuppeteerCrawlingContext, log } from "crawlee";
...
export class PuppeteerEngine extends BaseEngine {
    ...
    async init(): Promise<void> {
        ...
        const failedRequestHandler = async (context: PuppeteerCrawlingContext<Dictionary>, error: Error) => {
