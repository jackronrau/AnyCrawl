...
export const locales: LocaleData[] = [
    ...
    { code: 'ar-SA', name: 'العربية', region: 'المملكة العربية السعودية', englishName: 'Arabic', flag: '🇸🇦' },
    ...
    { code: 'en-GB', name: 'English', region: 'United Kingdom', englishName: 'English', flag: '🇬🇧' },
    ...
    { code: 'id-ID', name: 'Indonesia', region: 'Indonesia', englishName: 'Indonesian', flag: '🇮🇩' },
    ...
    { code: 'nb-NO', name: 'Norsk Bokmål', region: 'Norge', englishName: 'Norwegian Bokmål', flag: '🇳🇴' },
    ...
    { code: 'vi-VN', name: 'Tiếng Việt', region: 'Việt Nam', englishName: 'Vietnamese', flag: '🇻🇳' },
    { code: 'zh', name: '中文', region: '', englishName: 'Chinese', flag: '🌐' },
    { code: 'zh-CN', name: '中文', region: '中国', englishName: 'Chinese', flag: '🇨🇳' },
    { code: 'zh-HK', name: '中文', region: '中國香港特別行政區', englishName: 'Chinese', flag: '🇭🇰' },
